                ...
                <Wrapper id="swap-page" style={{ minHeight: '412px' }}>
                    ...
                    <AutoColumn justify="space-between">
                      <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                        ...
                        >
                          <ArrowDownIcon
                            className="icon-down"
                            color={currencies[Field.INPUT] && currencies[Field.OUTPUT] ? '#E85F34' : 'text'}
                          />
                          <ArrowUpDownIcon
                  ...
                  <Box mt="0.25rem">
                    {swapIsUnsupported ? (
                      ...
                      <RowBetween>
                        <Button
                          variant={approval === ApprovalState.APPROVED ? 'success' : '#E85F34'}
                        ...
                        <Button
                          variant={isValid && priceImpactSeverity > 2 ? 'danger' : '#E85F34'}
                      ...
                      <Button
                        variant={isValid && priceImpactSeverity > 2 && !swapCallbackError ? 'danger' : '#E85F34'}
                        onClick={() => {
                          if (isExpertMode) {
                            handleSwap()
                          } else {
